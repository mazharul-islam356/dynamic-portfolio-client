...
const experienceData = [
  {
    ...
    type: "Full-time",
    description:
      "Led the frontend development team in building scalable web applications using modern technologies. Collaborated with cross-functional teams to deliver high-quality products.",
    responsibilities: [
  ...
  },
  {
    ...
    type: "Full-time",
    description:
      "Worked on multiple client projects building interactive web applications. Focused on creating pixel-perfect designs and smooth user experiences.",
    responsibilities: [
      "Built responsive websites and web applications from scratch",
      "Converted Figma and Adobe XD designs into functional code",
